...
for year_number in year:
    ...
    arcpy.management.ProjectRaster(Year_Average,
                                   r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Average/Year_Average" + str(year_number) + ".tif",
    ...
    out_point_features = (
                r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Average/Specimen_Location_" +
                str(year_number))
...
# Export the saved file as a .csv file
    import numpy
    fc = (r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Average/Specimen_Location_" +
          str(year_number) + ".shp")
