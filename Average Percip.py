...
for year_number in year:
    for month_number in month:
        arcpy.md.MakeNetCDFRasterLayer(
            r"C:\Users\evank\Documents\ArcGIS\Projects\Temperature\precip.mon.total.v501.nc",
            "precip", "lon", "lat", "precip_total_" + str(year_number) + "_" + str(month_number), '',
    ...
    arcpy.management.ProjectRaster(Year_Precip_Average,
                                   r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Precip Average/Year_Precip_Average" + str(year_number) + ".tif",
    ...
    out_point_features = (
                r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Precip Average/Specimen_Location_" +
                str(year_number))
...
# Export the saved file as a .csv file
    import numpy
    fc = (r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Precip Average/Specimen_Location_" +
          str(year_number) + ".shp")
