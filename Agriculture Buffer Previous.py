...
for yearbin in years:
    points = r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Land Use Specimens/Points_DecadeAfter/morph.data.previous" + str(yearbin) + ".csv"
...
for yearbin in years:
    points = r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Land Use Specimens/Canada/morph.data.previous" + str(yearbin) + ".csv"
    out_point_features = str(r"C:\Users\evank\Documents\ArcGIS\Projects\Temperature\Temperature.gdb\land_use_points_" + str(yearbin))
    arcpy.management.XYTableToPoint(
        points,
