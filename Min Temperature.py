...
for year_number in year:
    ...
    # Execute Times
    Year_Min = arcpy.sa.CellStatistics(inRaster[0] + ";" + inRaster[1] + ";" + inRaster[2] + ";" + inRaster[3] + ";" + inRaster[4], "MINIMUM", "DATA");

    # Save the output
    arcpy.management.ProjectRaster(Year_Min,
                                   r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Min/Year_Min" + str(year_number) + ".tif",
    ...
    out_point_features = (
                r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Min/Specimen_Location_" +
                str(year_number))
    ExtractValuesToPoints(in_point_features, "Year_Min" + str(year_number) + ".tif", out_point_features, "NONE", "Value_ONLY")
# Export the saved file as a .csv file
    import numpy
    fc = (r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable/Yearly Min/Specimen_Location_" +
          str(year_number) + ".shp")
    ...
    arcpy.Delete_management("Year_Min" + str(year_number) + ".tif")
