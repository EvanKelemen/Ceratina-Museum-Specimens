...
for year_number in year:
    ...
    # Execute Times
    Year_Precip_Average = (Raster(inRaster[0]) + Raster(inRaster[1]) + Raster(inRaster[2])) / 3
    # Save the output
    arcpy.management.ProjectRaster(Year_Precip_Average,
                                   r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable CRU/Previous Precip/Year_Precip_Average" + str(year_number) + ".tif",
    ...
    out_point_features = (
                r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable CRU/Previous Precip/Specimen_Location_" +
                str(year_number))
...
# Export the saved file as a .csv file
    import numpy
    fc = (r"C:/Users/evank/Documents/ArcGIS/Projects/Temperature/Temperature Variable CRU/Previous Precip/Specimen_Location_" +
          str(year_number) + ".shp")
